...
print("Submitting health profile to FastAPI ML matching pipeline...")
try:
    ...
    if response.status_code == 200:
        ...
        print(f"SHAP Feature Importance Explanation: {json.dumps(data['risk_assessment']['feature_importance_explanation'], indent=2)}")
